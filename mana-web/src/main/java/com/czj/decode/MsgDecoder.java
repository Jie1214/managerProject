...
import com.czj.utils.BitOperator;
import com.czj.utils.MsgParseUtils;
...
public class MsgDecoder {
    ...
    public static PackageData bytesToPackageData(byte[] data){
        PackageData pData = new PackageData();
        //数据主要由三部分组成
        //1. 消息头 16byte 或者12byte
        PackageData.MsgHeader msgHeader = parseMsgHeaderFromBytes(data);
    ...
    //消息头的解析
    private static PackageData.MsgHeader parseMsgHeaderFromBytes(byte[] data) {
